...
contract DUMPDOGE is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x85b8a9caEa3394bd00fD0Fc0aF81A15067BEB772); // Marketing Address
    ...
    string private _name = "DUMP DOGE";
    string private _symbol = "DUMPDOGE";
